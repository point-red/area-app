<!-- components/table/TableSettingModal.vue -->
...
<template>
  <base-modal :is-open="isOpen" @on-close="close()" size="xl">
    <div class="max-h-90vh overflow-auto p-8 space-y-6">
      <h2 class="text-2xl font-bold">Table Setting</h2>

      <div class="space-y-2">
        <h3 class="font-extrabold text-lg">Column Visibility</h3>
        <div class="space-y-2">
          <base-checkbox
          ...
          <template v-slot="{ checked, option }">
            <div class="w-full cursor-pointer">
              <div
                ...
                class="border rounded min-w-20 p-2"
              >
