  ...
  <base-card class="max-w-xl">
    <form @submit.prevent="onSubmit" class="flex flex-col gap-8">
      <div class="flex flex-col gap-4">
        <base-input label="New Password" layout="vertical" required :disabled="isLoading" :type="passwordStore.type"
        ...
        <base-input label="Password Confirmation" layout="vertical" required :disabled="isLoading"
