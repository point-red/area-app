...
import { deleteRoleApi } from './delete.api'
...
const onDelete = async () => {
  ...
  try {
    ...
    // start api call
    const responseDelete = await deleteRoleApi(_id.value as string)
    if (!responseDelete) {
      form.data.password = ''
      return
    }
    ...
    <div class="max-h-90vh overflow-auto p-4">
      ...
      <div class="space-y-8">
        ...
        <div class="flex flex-col gap-2">
          ...
          <base-textrole label="Reason" v-model="form.data.reason" :errors="form.errors.reason" :min-height="64"
